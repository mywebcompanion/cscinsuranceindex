...
AdminApp.controller('DeleteCompanyController', function($scope, $state, AdminFactory,Flash, editcompanies) {

    $scope.companylist = editcompanies;
    $scope.editcompany = function(companyname, market){
